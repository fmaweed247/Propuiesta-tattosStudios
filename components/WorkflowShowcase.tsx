...
// 2. USA LA DEFINICIÓN COMPLETA Y CORRECTA del componente FlowStep
    ...
    return (
        <section id="workflow-showcase" className="mb-16">
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg">
                ...
                >
                    <img src={formScreenshot} alt="Formulario web para solicitar cita de tatuaje" className="rounded-md shadow-lg max-w-full h-auto border border-gray-700"/>
                </FlowStep>
                ...
                >
                    <img src={emailCliente} alt="Email de confirmación enviado al cliente" className="rounded-md shadow-lg max-w-full h-auto border border-gray-300"/>
                </FlowStep>
                ...
                <div className="flow-step text-center mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-4">
                        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4">
                            ...
                            <img src={emailEquipoConImagen} alt="Notificación al equipo con imagen de referencia" className="rounded-md shadow-lg w-full h-auto border"/>
                        </div>
                        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4">
                           <h4 className="text-lg font-bold text-center mb-2">📄 Sin Imagen de Referencia</h4>
                           <img src={emailEquipoSinImagen} alt="Notificación al equipo sin imagen de referencia" className="rounded-md shadow-lg w-full h-auto border"/>
                        </div>
                    </div>
                </div>
                ...
                <div className="flow-step text-center">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6 mt-4 text-left">
                        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4">
                            ...
                            <img src={sheetsLeads} alt="Registro de consultas en Google Sheets" className="rounded-md shadow-lg w-full h-auto border"/>
                        </div>
                        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4">
                            <h4 className="font-bold text-center mb-2">📈 Google Sheets - Métricas</h4>
                            <img src={sheetsMetrics} alt="Métricas de consultas en Google Sheets" className="rounded-md shadow-lg w-full h-auto border"/>
                        </div>
                        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4">
                            <h4 className="font-bold text-center mb-2">📁 Google Drive</h4>
                            <img src={driveScreenshot} alt="Imágenes de referencia guardadas en Google Drive" className="rounded-md shadow-lg w-full h-auto border"/>
                        </div>
                    </div>
                </div>
            </div>
